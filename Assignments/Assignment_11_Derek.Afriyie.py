...
if len(filename) < 1 :
	filename = open("regex_sum_242232.txt").read()
numbers_found = re.findall('\d+',filename)
#store my list of numbers that
#converted the content in my list to ints
#than appended it to an empty list
vals = map(int, numbers_found)
...
#filename.close()
#numbers_list.append(numbers_found)
